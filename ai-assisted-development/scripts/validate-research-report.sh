...
# Check 2: Path pattern matches docs/research/web/YYYY-MM-DD-*.md
if [[ ! "$FILE_PATH" =~ docs/research/web/[0-9]{4}-[0-9]{2}-[0-9]{2}-.+\.md$ ]]; then
  ERRORS+=("Path does not match pattern: docs/research/web/YYYY-MM-DD-*.md")
