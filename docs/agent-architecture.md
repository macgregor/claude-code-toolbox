...
Users can coordinate multiple agents by invoking them sequentially:
- Run research agents (web-research, codebase-research) as needed
- Each writes output to file (`docs/research/web/*.md`, `docs/research/codebase/*.md`)
- Synthesis agent combines multiple reports when needed
- Users decide order and which agents to invoke
